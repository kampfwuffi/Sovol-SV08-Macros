...
> [!CAUTION]
>- Stock Sovol hardware required. **0.6mm** nozzle preconfigured. For  **0.4mm** nozzle minor code adjustment required in _printer.cfg_. See below on the end of this readme (Step 5).
...
- Reboot machine
- Set nozzle diameter in _printer.cfg_ and (Orca) slicer! See Step 5.
...
## **STEP 5: OPTIONAL for 0.4mm or 0.6 mm nozzle:**
